...
#define	stringframe_name                        "Данные полного кадра"
#define	stringlines_name                        "Данные полос с кадра"
#define	stringwindow_name                       "Данные окон с кадра"
...
struct STARREC
{
	WORD Ns, Is; // номер звезды, интегральная яркость
...
#pragma region dev_angular_velocity
		Value_String = "";
		Value_String += FormatFloat("0.000000 ", Georeferencing.DeviceAngularVelocity[0]);
		Value_String += FormatFloat("0.000000 ", Georeferencing.DeviceAngularVelocity[1]);
		Value_String += FormatFloat("0.000000", Georeferencing.DeviceAngularVelocity[2]);
		PrintString(FStream, dev_angular_velocity_id, dev_angular_velocity_name, Value_String);
#pragma end_region
#pragma region dev_angular_acceler
		Value_String = "";
		Value_String += FormatFloat("0.000000 ", Georeferencing.DeviceAngularAcceleration[0]);
		Value_String += FormatFloat("0.000000 ", Georeferencing.DeviceAngularAcceleration[1]);
		Value_String += FormatFloat("0.000000", Georeferencing.DeviceAngularAcceleration[2]);
		PrintString(FStream, dev_angular_acceler_id, dev_angular_acceler_name, Value_String);
#pragma end_region
#pragma region proj_line_velo
		Value_String = "";
		Value_String += FormatFloat("0.000000 ", Georeferencing.ProjectionLinearVelocity[0]);
		Value_String += FormatFloat("0.000000 ", Georeferencing.ProjectionLinearVelocity[1]);
		Value_String += FormatFloat("0.000000", Georeferencing.ProjectionLinearVelocity[2]);
		PrintString(FStream, proj_line_velo_id, proj_line_velo_name, Value_String);
#pragma end_region
#pragma region type_angle
		Value_String = "";
		Value_String += FormatFloat("0.000000 ", Georeferencing.OrientationAngles[0]);
		Value_String += FormatFloat("0.000000 ", Georeferencing.OrientationAngles[1]);
		Value_String += FormatFloat("0.000000", Georeferencing.OrientationAngles[2]);
...
#pragma region type_quat
		...
		{
			Value_String = "";
			Value_String += FormatFloat("0.000000 ", Georeferencing.OrientationQuaternion[0]);
			Value_String += FormatFloat("0.000000 ", Georeferencing.OrientationQuaternion[1]);
			Value_String += FormatFloat("0.000000 ", Georeferencing.OrientationQuaternion[2]);
			Value_String += FormatFloat("0.000000", Georeferencing.OrientationQuaternion[3]);
...
#pragma region type_matr
		...
		{
			Value_String += "{";
			Value_String += FormatFloat("0.000000 ", Georeferencing.OrientationMatrix[i][0]);
			Value_String += FormatFloat("0.000000 ", Georeferencing.OrientationMatrix[i][1]);
			Value_String += FormatFloat("0.000000} ", Georeferencing.OrientationMatrix[i][2]);
		}
...
#pragma region function_distortion
		if (Georeferencing.DistortionApply)
		{
			...
			{
				Value_String = "";
				Value_String += FormatFloat("#0.000000000000 ", CameraSettings.DistortionFunction.Coefficient[i].X);
				Value_String += FormatFloat("#0.000000000000", CameraSettings.DistortionFunction.Coefficient[i].Y);
...
#pragma region dead_pix
		if (CameraSettings.TableDeadObjects.RecordsCount != 0)
		{
			...
			{
				Value_String = "";
				Value_String += FormatFloat("#0000.000000 ", CameraSettings.TableDeadObjects.PixelData[i].X_coordinate);
				Value_String += FormatFloat("#0000.000000 ", CameraSettings.TableDeadObjects.PixelData[i].Y_coordinate);
				Value_String += FormatFloat("#0000.000000 ", CameraSettings.TableDeadObjects.PixelData[i].BrightnessObj);
				Value_String += FormatFloat("000000", CameraSettings.TableDeadObjects.PixelData[i].CoefficientObj);
				print_AnsiString(FStream, Value_String);
			}
		}
#pragma end_region
...
#pragma end_region
		if (FilterData.FilteredPixelsCount != 0)
		{
			...
			{
				Value_String = "";
				Value_String += FormatFloat("000000 ", FilterData.DataPixels[i].X_coordinate);
				Value_String += FormatFloat("000000 ", FilterData.DataPixels[i].Y_coordinate);
				Value_String += FormatFloat("000000", FilterData.DataPixels[i].BrightnessPixel);
				print_AnsiString(FStream, Value_String);
			}
		}
#pragma end_region
...
#pragma region local_recog
		if (StarsData.LocalizedCount != 0)
		{
			...
			{
				Value_String = "";
				Value_String += FormatFloat("#0000.00000 ", StarsData.StarsList[i].BrightnessObject);
				Value_String += FormatFloat("#0000.00000 ", StarsData.StarsList[i].PixelsCount);
				Value_String += FormatFloat("#0000.00000 ", StarsData.StarsList[i].X_coordinate);
				Value_String += FormatFloat("#0000.00000 ", StarsData.StarsList[i].Y_coordinate);
				if (StarsData.StarsList[i].NumberStar == 0)
					goto endlist;
				else
					Value_String += FormatFloat("000000 ", StarsData.StarsList[i].NumberStar);
				...
				Value_String += FormatFloat("#0000.00000 ", StarsData.StarsList[i].DX);
				Value_String += FormatFloat("#0000.00000", StarsData.StarsList[i].DY);
...
#pragma region rec
		if (StarsData.SimulatedFrame.strrec != 0)
		{
			...
			{
				Value_String = "";
				Value_String += FormatFloat("00000 ", StarsData.SimulatedFrame.StarRec[i].Ns);
				Value_String += FormatFloat("00000 ", StarsData.SimulatedFrame.StarRec[i].Is);
				Value_String += FormatFloat("#0000.00000 ", StarsData.SimulatedFrame.StarRec[i].Xs);
				Value_String += FormatFloat("#0000.00000 ", StarsData.SimulatedFrame.StarRec[i].Ys);
...
#pragma region rec_orient_angl
		...
		{
			Value_String = "";
			Value_String += FormatFloat("0.000000 ", StarsData.RecognizedOrientationAngles[0]);
			Value_String += FormatFloat("0.000000 ", StarsData.RecognizedOrientationAngles[1]);
			Value_String += FormatFloat("0.000000", StarsData.RecognizedOrientationAngles[2]);
...
#pragma region rec_orient_quat
		...
		else
		{
			Value_String = "";
			for (int i = 0; i < 4; i++)
				Value_String += FormatFloat("0.000000 ", StarsData.RecognizedOrientationQuaternion[i]);
...
#pragma region rec_orient_matr
		...
		else
		{
			...
			{
				Value_String += "{";
				Value_String += FormatFloat("0.000000 ", StarsData.RecognizedOrientationMatrix[i][0]);
				Value_String += FormatFloat("0.000000 ", StarsData.RecognizedOrientationMatrix[i][1]);
				Value_String += FormatFloat("0.000000} ", StarsData.RecognizedOrientationMatrix[i][2]);
			}
...
#pragma region stringframe
		if (ImageData.FrameData.FrameWidth != 0 && ImageData.FrameData.FrameHeight != 0)
		{
			...
			PrintString(FStream, stringframe_id, stringframe_name, Value_String);
		}
#pragma end_region
#pragma region stringlines
		if (ImageData.LinesData.LinesCount != 0)
		{
			...
			PrintString(FStream, stringlines_id, stringlines_name, Value_String);
			for (int i = 0; i < ImageData.LinesData.LinesCount; i++)
			{
				Value_String = "";
				Value_String += FormatFloat("000000 ", ImageData.LinesData.Info[i].Y_FirstString);
				Value_String += FormatFloat("000000", ImageData.LinesData.Info[i].CountString);
				print_AnsiString(FStream, Value_String);
			}
		}
#pragma end_region
#pragma region stringwindow
		if (ImageData.WindowsData.WindowCount != 0)
		{
			...
			PrintString(FStream, stringwindow_id, stringwindow_name, Value_String);
			for (int i = 0; i < ImageData.WindowsData.WindowCount; i++)
			{
				Value_String = "";
				Value_String += FormatFloat("000000 ", ImageData.WindowsData.Info[i].WindowWidth);
				Value_String += FormatFloat("000000 ", ImageData.WindowsData.Info[i].WindowHeight);
				Value_String += FormatFloat("000000 ", ImageData.WindowsData.Info[i].X);
				Value_String += FormatFloat("000000 ", ImageData.WindowsData.Info[i].Y);
				Value_String += FormatFloat("000000 ", ImageData.WindowsData.Info[i].Limit);
				Value_String += FormatFloat("000000 ", ImageData.WindowsData.Info[i].ObjCount);
				Value_String += FormatFloat("0.000000 ", ImageData.WindowsData.Info[i].SKO);
				Value_String += FormatFloat("0.000000", ImageData.WindowsData.Info[i].Average);
				print_AnsiString(FStream, Value_String);
			}
		}
#pragma end_region
					...
					for (int i = 0; i < StarsData.SimulatedFrame.strrec; i++)
					{
						...
						for (int j = 0; j < 6; j++)
						{
							...
							if (pos_index != 0)
							{
								...
								case 1: StarsData.SimulatedFrame.StarRec[i].Is = (WORD) StrToFloat(buferstr.SubString(0, pos_index - 1)); break;
