...
//yP          - массив по У
//BrP         - массив яркостей
//NumPts      - длина массива
//NumIt       - чисто итераций (10)
//NumTr       - шаг внутри пикселя (10)
//flagCInit   - центр объекта
//			  0 - средневзвешенное
//			  1 - среднее арифмитическое
//			  2 - ярчайший пиксель
//sigmaInit   - начальная сигма (0.5)
//
//Результаты:
//xc          - центр гауссовой аппроксимации по Х
//yc          - центр гауссовой аппроксимации по У
//sx          - значение сигмы по Х
//sy          - значение сигмы по У
//muG         - точность решения задачи аппроксимации (чем меньше - тем точнее)
//xi          - координаты центра выбранные в flagCInit по Х
//yi          - координаты центра выбранные в flagCInit по У
